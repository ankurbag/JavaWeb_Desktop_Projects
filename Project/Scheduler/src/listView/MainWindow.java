...
public class MainWindow extends BaseWindow
{
	...
	private void initMenuItems()
	{
		...
		item.setSelected((calendar.getListViewSettings().getHeaderStyle() & ListViewHeaderStyles.Subheader) != 0);
		item.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent arg0) {
				onToggleSubHeaders();
	...
	{
		int style = calendar.getListViewSettings().getHeaderStyle();
		if ((style & ListViewHeaderStyles.Subheader) == 0)
