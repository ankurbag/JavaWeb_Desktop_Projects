...
public class MainWindow extends BaseWindow
{
	...
	protected void onCalendarDraw(DrawEvent e)
	{
		if (e.getElement() == CustomDrawElements.TimetableCell)
		{
			...
			if (zone)
			{
				Brush b2 = new SolidBrush(new Color(20, 255, 255, 255));
				Brush b4 = null;
				if (type)
					b4 = new SolidBrush(new Color(75, Colors.Goldenrod));
				else
					b4 = new SolidBrush(new Color(75, Colors.LightSteelBlue));

				g.fillRectangle(b2, b);
				g.fillRectangle(b4, b.getLeft() + 1, b.getTop(), 30, b.getHeight());

				g.drawLine(p, b.getLeft() + 30, b.getTop(), b.getLeft() + 30, b.getBottom() - 1);

				g.drawLine(p, b.getLeft(), b.getTop(), b.getLeft(), b.getBottom() - 1);
				g.drawLine(p, b.getRight() - 1, b.getTop(), b.getRight() - 1, b.getBottom() - 1);

				if (zoneStart)
					g.drawLine(p, b.getLeft(), b.getTop(), b.getRight() - 1, b.getTop());

				if (zoneEnd)
					g.drawLine(p, b.getLeft(), b.getBottom() - 1, b.getRight() - 1, b.getBottom() - 1);

				b2.dispose();
				b4.dispose();
			}

			Brush b1 = new SolidBrush(new Color(40, 0, 0, 0));
			if (selected)
			{
				boolean start = false;
				boolean end = false;
	...
	{
		if (e.getButton() == MouseButtons.Left && e.getClicks() == 2)
		{
			calendar.resetDrag();
