...
public class MainWindow extends BaseWindow
{
	public MainWindow()
	{
		...
		calendar.getItemSettings().getSelectedItemStyle().setHeaderFont(new Font("Arial", 10, FontStyles.Bold | FontStyles.Italic));
		...
		calendar.getItemSettings().getStyle().setHeaderFont(new Font("Arial", 10, FontStyles.Bold | FontStyles.Italic));
