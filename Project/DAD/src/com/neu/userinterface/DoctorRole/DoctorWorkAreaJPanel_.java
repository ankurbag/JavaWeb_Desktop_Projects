 ...
 * @author raunak
 */
public class DoctorWorkAreaJPanel_ extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaJPanel_(JPanel userProcessContainer, UserAccount account, DoctorOrganization organization, Enterprise enterprise) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((AppointmentRequest) request).getAppointmentSlot();
